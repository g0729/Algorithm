# [Platinum IV] 알고리즘 수업 - 삽입 정렬 5 - 24055 

[문제 링크](https://www.acmicpc.net/problem/24055) 

### 성능 요약

메모리: 31832 KB, 시간: 276 ms
...
### 입력 
 ...
 <p>첫째 줄에 배열 A의 크기 <em>N</em>(5 ≤ <em>N</em> ≤ 500,000), 변경 횟수 <em>K</em>(1 ≤ <em>K</em> ≤ 10<sup>12</sup>)가 주어진다.</p>
